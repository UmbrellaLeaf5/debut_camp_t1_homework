package io.github.UmbrellaLeaf5.synth.core.metrics;
...
public class SyntheticHumanMetricService {
  ...
  private static final String CURRENT_ANDROID_BUSYNESS_METRIC_DESCRIPTION =
      "current android task queue size";
  private static final String CURRENT_ANDROID_PROCEED_TASKS_METRIC_NAME =
      "current_android_proceed_tasks";
  private static final String CURRENT_ANDROID_PROCEED_TASKS_METRIC_DESCRIPTION =
      "current android proceed tasks by author";
